...
enum {\bfseries hdlc\+\_\+crc\+\_\+t} \{ \newline
{\bfseries H\+D\+L\+C\+\_\+\+C\+R\+C\+\_\+\+D\+E\+F\+A\+U\+LT} = 0, 
{\bfseries H\+D\+L\+C\+\_\+\+C\+R\+C\+\_\+8} = 8, 
{\bfseries H\+D\+L\+C\+\_\+\+C\+R\+C\+\_\+16} = 16, 
{\bfseries H\+D\+L\+C\+\_\+\+C\+R\+C\+\_\+32} = 32, 
\newline
{\bfseries H\+D\+L\+C\+\_\+\+C\+R\+C\+\_\+\+O\+FF} = 0x\+FF
 \}
\end{DoxyCompactItemize}
...
\item 
int \hyperlink{group__HDLC__API_ga2d6e77ad3ac6ee53499afaa68cb69f72}{hdlc\+\_\+run\+\_\+rx} (\hyperlink{struct__hdlc__handle__t}{hdlc\+\_\+handle\+\_\+t} handle, void $\ast$data, int len)
\item 
...
\item 
int \hyperlink{group__HDLC__API_ga7bb27a8d4f2c975689cce856e16b4ae8}{hdlc\+\_\+send} (\hyperlink{struct__hdlc__handle__t}{hdlc\+\_\+handle\+\_\+t} handle, const void $\ast$data, int len)
\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{group__HDLC__API_ga2d6e77ad3ac6ee53499afaa68cb69f72}\label{group__HDLC__API_ga2d6e77ad3ac6ee53499afaa68cb69f72}} 
...
{\footnotesize\ttfamily int hdlc\+\_\+run\+\_\+rx (\begin{DoxyParamCaption}\item[{\hyperlink{struct__hdlc__handle__t}{hdlc\+\_\+handle\+\_\+t}}]{handle,  }\item[{void $\ast$}]{data,  }\item[{int}]{len }\end{DoxyParamCaption})}

Processes incoming data. Implementation of reading data from hw is user responsibility. If \hyperlink{group__HDLC__API_ga2d6e77ad3ac6ee53499afaa68cb69f72}{hdlc\+\_\+run\+\_\+rx()} returns value less than size of data passed to the function, then \hyperlink{group__HDLC__API_ga2d6e77ad3ac6ee53499afaa68cb69f72}{hdlc\+\_\+run\+\_\+rx()} must be called later second time with the pointer to and size of not processed bytes.
...
Runs transmission at hdlc level. If there is frame to send, or send is in progress, this function will call send\+\_\+tx() callback multiple times. If send\+\_\+tx() callback reports 0, that means that hw device is busy, then \hyperlink{group__HDLC__API_gae31d921043b4f175603114c206b6b829}{hdlc\+\_\+run\+\_\+tx()} will return immediately and \hyperlink{group__HDLC__API_gae31d921043b4f175603114c206b6b829}{hdlc\+\_\+run\+\_\+tx()} must be called later next time.
...
\end{DoxyReturn}
\mbox{\Hypertarget{group__HDLC__API_ga7bb27a8d4f2c975689cce856e16b4ae8}\label{group__HDLC__API_ga7bb27a8d4f2c975689cce856e16b4ae8}} 
...
{\footnotesize\ttfamily int hdlc\+\_\+send (\begin{DoxyParamCaption}\item[{\hyperlink{struct__hdlc__handle__t}{hdlc\+\_\+handle\+\_\+t}}]{handle,  }\item[{const void $\ast$}]{data,  }\item[{int}]{len }\end{DoxyParamCaption})}
